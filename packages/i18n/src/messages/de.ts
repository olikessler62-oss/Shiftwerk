export const de = {
  ...
  nav: {
    ...
    superadminTestScenarioBiergartenHadrianDescription:
      "Setzt den Organisationsnamen auf „Giovanni's Gastro“, entfernt alle bestehenden Standorte und Schichten, setzt Qualifikationen zurück (Kellner/in, Barista, Koch/Köchin, Spülkraft) und legt nur Biergarten und Hadrian-Eck neu an. Für aktuelle und nächste Kalenderwoche werden Schichten je nach Auswahl angelegt oder offen gelassen.",
    superadminTestScenarioBiergartenHadrianShiftModeLabel: "Schichten (aktuelle + nächste KW)",
    superadminTestScenarioBiergartenHadrianShiftModeOpen: "Nur offene",
    superadminTestScenarioBiergartenHadrianShiftModeCovered: "Nur besetzte",
    superadminTestScenarioBiergartenHadrianShiftModeMixed: "Offen/Besetzt gemischt",
