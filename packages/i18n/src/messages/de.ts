export const de = {
  ...
  nav: {
    ...
    dbResetConfirmBody:
      "Alle Daten dieser Organisation werden gelöscht — außer Organisation, Standorte, Rollen und Jobs. Profile, Auth-Logins, Schichten, Bereiche, Abwesenheiten und alle weiteren Planungsdaten gehen verloren. Danach wirst du abgemeldet.",
    dbResetConfirm:
      "Alle Daten dieser Organisation werden gelöscht — außer Organisation, Standorte, Rollen und Jobs.\n\nProfile, Auth-Logins, Schichten, Bereiche, Abwesenheiten und alle weiteren Planungsdaten gehen verloren. Danach wirst du abgemeldet.\n\nFortfahren?",
  },
  dashboard: {
    location: "Standort",
