export const de = {
  common: {
    ...
    weekPickerTitle: "Kalenderwoche wählen",
    weekPickerOpenDate: "Datum und Kalenderwoche öffnen",
    weekPickerSelectWeek: "Kalenderwoche {week} auswählen",
    weekPickerCurrentWeek: "Aktuelle Woche",
    currentWeekHint: "(aktuelle Woche)",
    close: "Schließen",
    apply: "Übernehmen",
    back: "Zurück",
    cancel: "Abbrechen",
  ...
  nav: {
    dashboard: "Dashboard",
    calendar: "Kalender",
    areaCalendar: "Einsatzbereich-Kalender",
    employeeCalendar: "Mitarbeiter-Kalender",
    planning: "Einsatzbereich-Kalender",
    ...
    superadminTabTestScenarios: "Testszenarien",
    superadminTestScenariosHint:
      "Legt strukturierte Testdaten an — Mitarbeiter und Qualifikationen bleiben unverändert.",
    superadminTestScenarioRun: "Anlegen",
    superadminTestScenarioPending: "Wird angelegt…",
    superadminTestScenarioBiergartenHadrianTitle: "L'Orangerie & Biergarten",
    superadminTestScenarioBiergartenHadrianDescription:
      "Setzt den Organisationsnamen auf „Giovanni's Gastro“, entfernt alle bestehenden Standorte und Schichten, setzt Qualifikationen zurück (Kellner/in, Barista, Koch/Köchin, Spülkraft) und legt nur L'Orangerie und Biergarten als zwei getrennte Standorte neu an. Für aktuelle und nächste Kalenderwoche werden Schichten je nach Auswahl angelegt oder offen gelassen.",
    superadminTestScenarioShiftsPerDayLabel: "Schichten pro Tag",
    superadminTestScenarioShiftsPerDayOne: "Eine Schicht pro Tag",
    superadminTestScenarioShiftsPerDayTwo: "Zwei Schichten pro Tag",
    superadminTestScenarioShiftsPerDayThree: "Drei Schichten pro Tag",
    superadminTestScenarioShiftLabel: "Schicht {index}",
    superadminTestScenarioTabBiergarten: "Biergarten",
    superadminTestScenarioTabFriseur: "Friseur",
    superadminTestScenarioTabPflege: "Pflege",
    superadminTestScenarioShiftModeLabel: "Besetzung",
    superadminTestScenarioShiftModeOpen: "Nur offene",
    superadminTestScenarioShiftModeCovered: "Nur besetzte",
    superadminTestScenarioShiftModeMixed: "Offen/Besetzt gemischt",
    superadminTestScenarioBiergartenHadrianSuccess:
      "Szenario „Giovanni's Gastro“ angelegt (KW ab {weekStart}, 2 Wochen): {locationCount} Standorte, {areaCount} Bereiche, {shiftCount} Schichten — {coveredSlots} gedeckte und {openSlots} offene Bedarfsslots.",
    superadminTestScenarioFriseurSalonZentraleTitle: "Zentrale · Friseur-Salon",
    superadminTestScenarioFriseurSalonZentraleSuccess:
      "Szenario „Lucy's Hairstylings“ angelegt (KW ab {weekStart}): {locationCount} Standort, {areaCount} Einsatzbereich, {shiftCount} bestätigte Schichten — {coveredSlots} besetzte Bedarfsslots, {openSlots} offen.",
    superadminTestScenarioPflegedienstZentraleTitle: "Medicare Pflegedienst",
    superadminTestScenarioPflegedienstZentraleSuccess:
      "Szenario „Giovanni's Gastro“ angelegt (KW ab {weekStart}): Standort „Medicare Pflegedienst“ mit {areaCount} Einsatzbereichen (Tour 1–5), {shiftCount} bestätigte Schichten — {coveredSlots} besetzte Bedarfsslots, {openSlots} offen.",
    ...
    superadminCleanupConfirmationConflicts: "Bestätigungs-Duplikate bereinigen",
    superadminCleanupConfirmationConflictsPending: "Bereinige Duplikate…",
    superadminCleanupConfirmationConflictsRun: "Bereinigen",
    superadminCleanupConfirmationConflictsDone:
      "{count} widersprüchliche oder doppelte Schicht-Einträge bereinigt.",
    superadminCleanupConfirmationConflictsNone:
      "Keine widersprüchlichen Bestätigungs-Duplikate gefunden.",
    superadminCleanupConfirmationConflictsConfirmTitle:
      "Bestätigungs-Duplikate bereinigen?",
    superadminCleanupConfirmationConflictsConfirmBody:
      "Für {count} Schicht(en) existieren widersprüchliche oder doppelte Bestätigungs-Einträge für dieselbe Person im gleichen Zeitraum (z. B. ausstehend und abgelehnt oder zweimal abgelehnt). Offene Konflikte werden auf „Abgelehnt“ gesetzt, echte Duplikate werden entfernt.",
  ...
  superadmin: {
    errors: {
      ...
      cleanupConfirmationConflictsFailed:
        "Bestätigungs-Duplikate konnten nicht bereinigt werden.",
      ...
      seedTestScenarioFailed: "Testszenario konnte nicht angelegt werden.",
    },
  },
  calendarStaffing: {
  ...
  areaCalendar: {
    ...
    staffingOverstaffedGaugeFootnote: "Mehr Personal, als Bedarf",
    staffingConflictOverstaffedLine:
      "{time} · {name} · {position}: mehr Personal, als benötigt",
    staffingConflictMismatchLine:
      "{time} · {name} · zugerechnet als {position}, fehlt: {missing}",
    staffingConflictNoQualLine:
      "{time} · {name} · keine passende Qualifikation (fehlt: {missing})",
    staffingTooltipConflictsHeading: "Konflikte",
    staffingTooltipHintsHeading: "Hinweise",
    staffingTooltipConflictMismatchTitle: "Qualifikationskonflikt",
    staffingTooltipConflictMismatchDescription:
      "{time} · {name} · zugerechnet als {position}, fehlt: {missing}",
    staffingTooltipConflictNoQualTitle: "Keine passende Qualifikation",
    staffingTooltipConflictNoQualDescription:
      "{time} · {name} · fehlt: {missing}",
    staffingTooltipHintOverstaffedTitle: "Überbedarf",
    staffingTooltipHintOverstaffedDescription:
      "{time} · {name} · {position}",
    staffingTooltipHintOverstaffedNote: "mehr Personal, als benötigt",
    ...
    staffingTooltipQualVacant: "{count}/{required} für {name}{shiftTime} offen",
    staffingTooltipTotalConfirmed: "{assigned}/{required}{shiftTime} bestätigt",
    staffingTooltipTotalUnconfirmed: "{assigned}/{required}{shiftTime} angefragt",
    staffingTooltipTotalPlanned: "{assigned}/{required}{shiftTime} geplant",
    staffingTooltipTotalVacant: "{count}/{required}{shiftTime} offen",
    ...
    noShiftTemplatesForArea:
      "Für diesen Einsatzbereich sind noch keine Schichtvorlagen hinterlegt. Legen Sie welche unter Standorte → Einsatzbereich → Schichtvorlagen an.",
  },
  shiftTypes: {
    title: "Schichtarten",
  ...
  locations: {
    ...
    areasEmpty: "Noch keine Einsatzbereiche für diesen Standort.",
    ...
    areaEdit: "Ändern",
    areaDelete: "Löschen",
    areaCreateTitle: "Einsatzbereich anlegen",
    areaEditTitle: "Einsatzbereich bearbeiten",
    ...
    archiveHint:
      "Entfernte Standorte und Einsatzbereiche werden archiviert — bestehende Schichten und spätere Kosten bleiben korrekt zuordenbar.",
    weekdays: {
      monday: "Montag",
    ...
    panelAreas: "Einsatzbereiche",
    panelAreasOf: "Einsatzbereiche von {location}",
    panelDetails: "Details",
    panelSelected: "Einsatzbereich",
    ...
    selectAreaHint: "Bitte zuerst einen Einsatzbereich auswählen.",
    ...
    actionQualificationTemplatesHint: "Tätigkeiten für diesen Einsatzbereich festlegen",
    actionQualificationTemplatesConfigured: "Tätigkeitsvorlagen hinterlegt",
    areaQualificationTemplatesHint:
      "Welche Tätigkeiten an diesem Einsatzbereich für Personalbedarf relevant sind.",
    areaQualificationTemplatesEmpty:
      "Noch keine Tätigkeitsvorlagen für diesen Einsatzbereich.",
    ...
    areaShiftTemplatesHint:
      "Optional: Vorlagen zum schnellen Ausfüllen von Zeiten beim Zuweisen im Einsatzbereich-Kalender.",
    areaShiftTemplatesEmpty: "Noch keine Schichtvorlagen für diesen Einsatzbereich.",
    ...
    areaShiftTemplatesMax: "Maximal {max} Schichtvorlagen pro Einsatzbereich.",
    areaShiftTemplatesCopyApply: "Schichtvorlagen übernehmen von",
    areaShiftTemplatesCopySelectArea: "Einsatzbereich mit Schichtvorlagen",
    ...
    serviceHoursCopySelectArea: "Einsatzbereich mit Servicezeiten",
    ...
    staffingNoServiceHours:
      "Legen Sie zuerst Servicezeiten für diesen Einsatzbereich an.",
    staffingNoQualifications:
      "Legen Sie zuerst Tätigkeiten unter Einstellungen an.",
    staffingNoAreaQualificationTemplates:
      "Für diesen Einsatzbereich sind noch keine Tätigkeitsvorlagen hinterlegt. Bitte unter Standorte → Tätigkeitsvorlagen mindestens eine Tätigkeit zuweisen.",
    staffingAllQualificationsAssigned:
      "Alle Tätigkeiten dieses Einsatzbereichs sind bereits eingetragen.",
    ...
    staffingCopySelectArea: "Einsatzbereich mit Personalbedarf",
    staffingListHint:
  ...
  settings: {
    ...
    organizationNameHint: "Wird in der Anwendung als Name Ihres Betriebs angezeigt. Maximal 30 Zeichen.",
    shiftConfirmationPendingAfterLabel: "Frist bis Status „Ausstehend“",
    shiftConfirmationPendingAfterHint:
      "Zeit nach einer Bestätigungsanfrage, ab der der Status von „Angefragt“ auf „Ausstehend“ wechselt.",
  ...
  dashboardExt: {
    placeholder: "Experiment — Inhalt folgt.",
    pageIntro:
      "Auf einen Blick: Jeder Bereich in einer Spalte — Engpässe sofort erkennbar, Details per Klick auf eine Karte.",
    homeIntro:
      "Kurzüberblick für die gewählte Woche — tippe auf eine Karte für Details.",
    sectionWeek: "Woche",
    sectionGaps: "Engpässe",
    sectionToday: "Heute",
    sectionAreas: "Bereiche",
    sectionWeekDays: "Wochentage",
    sectionDay: "Tag",
    sectionConflicts: "Hinweise",
    homeWeekCoverage: "{percent} % des Personalbedarfs gedeckt",
    homeGapsHeadlineOk: "Alles im grünen Bereich",
    homeGapsHeadlineOpen: "{count} offene Stellen",
    homeGapsHeadlineIssues: "{count} Hinweise",
    homeGapsDetailCritical: "{count} Bereiche kritisch unterbesetzt",
    homeTodayOne: "1 Schicht heute",
    homeTodayMany: "{count} Schichten heute",
    homeTodayNone: "Heute keine Schichten",
    homeTodayTomorrow: "Morgen: {count} Schichten",
    homeAreasHeadline: "{count} Bereiche",
    homeAreasDetail: "Ampel & Schichtanzahl pro Bereich",
    areaActiveDaysHeadline: "{count} Tage mit Schichten",
    areaActiveDaysDetail: "Verteilung über die Woche",
    weekDetailIntro: "Tage mit Schichten in diesem Bereich — antippen für Details.",
    daysDetailIntro: "Alle Wochentage — antippen für Schichtdetails.",
    openDayInCalendar: "Tag im Einsatzbereich-Kalender öffnen",
    dayRowGaps: "{count} offen · prüfen",
    dayOpenSlots: "{count} offen",
    dayNotFound: "Tag nicht gefunden.",
    areaOpenSlots: "{count} offen",
    areaNotFound: "Bereich nicht gefunden.",
    gapsNotAvailable: "Personalbedarf ist für diese Organisation deaktiviert.",
    gapsAllClear: "Keine offenen Stellen oder Hinweise in dieser Woche.",
    gapsOpenSlotsSummary: "Insgesamt {count} offene Stellen in dieser Woche.",
    openFullPlan: "Vollständigen Schichtplan öffnen",
    openAreaCalendar: "Einsatzbereich-Kalender öffnen",
    areaCalendarHint: "Schichten bearbeiten im",
  },
  dashboard: {
    summaryTitle: "Schichtübersicht",
    summaryWeekRange: "{range} · KW {week}",
    summaryEmpty: "In dieser Woche sind keine Schichten geplant.",
    summaryShiftCountOne: "1 Schicht",
    summaryShiftCountMany: "{count} Schichten",
    summaryColumnTime: "Zeit",
    summaryColumnShift: "Schicht",
    headerSubtitle: "Schichtplan",
    headerCalendarWeek: "KW {week}",
    statusCardPlanningWeek: "Planungswoche",
    statusCardAriaLabel: "Standort und Kalenderstatus",
    statusLocationAriaLabel: "Standort",
    statusDateAriaLabel: "Kalenderwoche",
    readOnlyWeek:
    ...
    kpiStaffingDemand: "Personalbedarf",
    kpiStaffingCoveragePercent: "{percent} % gedeckt",
    kpiOpenSlots: "Offene Slots",
    kpiCriticalAreasOne: "1 Bereich kritisch",
    kpiCriticalAreasMany: "{count} Bereiche kritisch",
    kpiTotalCost: "Kosten gesamt",
    kpiSurcharges: "Zuschläge",
    kpiBaseCompensation: "Entgelt {amount}",
    opsHealthLabel: "Wochen-Score",
    opsHealthGood: "Stabil",
    opsHealthWatch: "Beobachten",
    opsHealthCritical: "Kritisch",
    opsWeekCoverage: "Wochenabdeckung",
    opsOpenSlotsWeek: "Offen (Woche)",
    opsCriticalAreas: "Kritische Bereiche",
    opsTodayOk: "Heute vollständig besetzt",
    opsTodayOpen: "{count} offene Stellen heute",
    opsShiftsToday: "{count} Schichten heute",
    ampelStatusCovered: "Gedeckt",
    ampelStatusOverstaffed: "Überbesetzt",
    ampelStatusOpenSlots: "{count} offen",
    ampelStatusCritical: "{count} offen · kritisch",
    ampelStatusNoDemand: "Kein Bedarf definiert",
    ampelBadgeCritical: "Noch unbesetzte Schichten",
    ampelBadgeCriticalPast: "unbesetzte Schichten",
    ampelBadgePlanned: "Geplant",
    ampelHeaderConfirmationConflict: {
      requested: "Angefragte Bestätigungen",
      pending: "Ausstehende Anfragen",
      rejected: "Abgelehnte Anfragen",
      canceled: "Abgesagte Schichten",
      unresolved: "Ungeklärte Schichten",
    },
    ampelHeaderStaffingConflicts: "Konflikte & Hinweise zur Einteilung",
    ampelBadgePartial: "Lücken",
    ampelStaffingWeekCaption: "Besetzt/Bedarf",
    ampelStaffingHeaderSegment: {
      understaffed: "{assigned}/{required} unbesetzte Schichten",
      planned: "{assigned}/{required} geplante Schichten",
      mismatch: "{assigned}/{required} Schichten mit Qualifikationskonflikt",
      overstaffed: "{assigned}/{required} überbesetzte Schichten",
      met: "{assigned}/{required} bestätigte Schichten",
    },
    calendarNavEmployee: "Mitarbeiter-Kal.",
    calendarNavArea: "Einsatzbereich-Kal.",
    areaScopeToday: "Heute",
    areaScopeWeek: "Woche",
    areaScopeAriaLabel: "Zeitraum für Bereichsinformationen",
    areaAssignmentOverviewButton: "Übersicht",
    areaAssignmentOverviewTitle: "Übersicht - Schichten/Einsatzzeiten",
    areaAssignmentOverviewAssign: "Zuweisen",
    areaAssignmentOverviewEmpty: "Keine Schichten oder offenen Bedarfsslots in diesem Zeitraum.",
    areaAssignmentOverviewEmptyWindow: "Keine Einsätze in diesem Fenster.",
    areaAssignmentOverviewStaffingCounts: "{assigned}/{required} besetzt",
    areaAssignmentOverviewStatusLabel: "Status",
    areaAssignmentOverviewWindowStatusUnderstaffed: "Unterbesetzt",
    areaAssignmentOverviewWindowStatusPlanned: "Geplant",
    areaAssignmentOverviewWindowStatusMet: "Gedeckt",
    areaAssignmentOverviewWindowStatusOverstaffed: "Überbesetzt",
    areaAssignmentOverviewOpenSlot: "{qualification} — {count} offen",
    backToWeekView: "zurück zur Wochenansicht",
    weekTrayHeaderIntro: "Wöchentliche Schichten/Einsatzzeiten für:",
    weekTrayDayCardHint:
      "Klick auf Datum-Bereich einer Tag-Karte oder auf einzelne Einsatzbereiche, öffnet die detailierte Tagesansicht",
    dayCardOpenAreaAriaLabel: "Nur {area} in der Tagesansicht",
    dayCardNoShifts: "Keine Schichten",
    dayDrilldownShowAllAreas: "Alle Bereiche anzeigen",
    dayDrilldownAllAreas: "Alle Einsatzbereiche",
    dayDrilldownAreaComboboxAriaLabel: "Einsatzbereich in der Tagesansicht auswählen",
    dayDrilldownDayComboboxAriaLabel: "Tag in der Tagesansicht auswählen",
    dayCardConfirmationTooltipTitle: "Schichtstatus",
    dayCardFooterLine: {
      open: "offen",
      proposed: "geplant",
      requested: "angefragt",
      ...
      rejected: "abgelehnt",
      canceled: "abgesagt",
      swap_requested: "MA fragt Tausch an",
      unresolved: "unklar",
    },
    ...
    staffingIssuesModalTitle: "Konflikte & Hinweise · {area}",
    staffingIssuesModalSubtitle:
      "Qualifikationskonflikte und Überbedarf bei der Schichtplanung.",
    staffingIssuesButtonLabelOne: "Konflikte & Hinweise zur Einteilung anzeigen",
    staffingIssuesButtonLabelMany:
      "{count} Konflikte & Hinweise zur Einteilung anzeigen",
    staffingIssueUnderstaffedWindow:
      "{weekday} · {time} · {shift}: {assigned}/{required} besetzt",
    staffingIssueUnderstaffedQual:
      "{weekday} · {time} · {shift} · {qualification}: {assigned}/{required}",
    staffingIssueOverstaffed:
      "{weekday} · {time} · {shift} · {name} · {position}: mehr Personal, als benötigt",
    staffingIssueOverstaffedTitle: "Überbedarf",
    staffingIssueMismatch:
      "{weekday} · {time} · {shift} · {name} · zugerechnet als {position}, fehlt: {missing}",
    staffingIssueMismatchTitle: "Qualifikationskonflikt",
    staffingIssueNoQual:
      "{weekday} · {time} · {shift} · {name} · keine passende Qualifikation (fehlt: {missing})",
    staffingIssueNoQualTitle: "Keine passende Qualifikation",
    staffingIssueInlineOverstaffed:
      "{name} · {position}: mehr Personal, als benötigt",
    staffingIssueInlineMismatch:
      "{name} · zugerechnet als {position}, fehlt: {missing}",
    staffingIssueInlineNoQual:
      "{name} · keine passende Qualifikation (fehlt: {missing})",
    staffingRowConflictsBadge: "{count} Konflikte & Hinweise",
    staffingRowConflictsPopoverTitle: "Konflikte & Hinweise zur Einteilung",
    staffingWindowIssuesTitle: "Offene Punkte",
    staffingWindowIssuesButtonLabel: "Offene Punkte für Schichtfenster anzeigen",
    staffingWindowIssuesEmpty: "Keine offenen Punkte in diesem Schichtfenster.",
    ampelQualificationMismatch: "Qualifikation passt nicht",
    ampelSurchargesShort: "Zuschl.",
    ampelCompensationIncomplete: "Entgelt unvollständig",
    ampelHours: "{hours} Std.",
    ampelDetailShifts: "Schichten",
    ampelDetailHours: "Stunden",
    ampelDetailBreaks: "Pausen",
    ampelDetailTotalHours: "Gesamtstunden",
    ampelBreakHours: "-{hours} Std.",
    ampelDetailUnderstaffedWindows: "Unterbesetzte Zeiten",
    ampelDetailBaseCompensation: "Entgelt",
    ampelShowHoursAndCostSummary: "Stunden/Kosten anzeigen",
    ampelShowHoursSummary: "Stunden anzeigen",
    ampelSectionCritical: "Unterbesetzt",
    ampelSectionNonCritical: "Nicht kritisch",
    ampelColumnDay: "Tag",
    ampelColumnTime: "Uhrzeit",
    ampelColumnShift: "Schicht",
    ampelColumnStaffing: "Besetzt/Bedarf",
    staffingViewCompact: "Details pro Status",
    staffingViewIncludePastDays: "inkl. vergangener Tage",
    ampelNoServiceHours: "keine Servicezeiten",
    ...
    staffingCandidatesOpenCalendar: "Einsatzbereich-Kalender öffnen",
    staffingCandidatesHeadcountSection: "Personalbedarf",
    staffingCandidatesMissingCount: "{count} fehlend",
    staffingCandidatesLoading: "Personal wird geladen…",
    staffingCandidatesNoOpenSlots: "Kein offener Personalbedarf für diese Zeile.",
    staffingCandidatesProblemUnderstaffed: "Unterbesetzt",
    staffingCandidatesProblemMissingPrefix: " — fehlt: ",
    staffingCandidatesProblemMissingLine: "fehlt: {count}x {qualification}",
    staffingCandidatesProblemMissingLabel: "fehlt:",
    staffingCandidatesSuggestionTitle: "Vorschlag: Personal",
    staffingCandidatesSuggestionHint: "(gepr.: Planungskonflikte)",
    staffingCandidatesTopBadge: "Top",
    staffingCandidatesColumnName: "Name",
    staffingCandidatesColumnQualification: "Qualifikation",
    staffingCandidatesColumnAction: "Aktion",
    staffingCandidatesTooltipAbsence: "Abwesenheit",
    staffingCandidatesTooltipAvailability: "Verfügbarkeit",
    staffingCandidatesTooltipWeeklyHours: "Wochenstunden",
    weeklyHoursTotalLabel: "Summe",
    staffingCandidatesTooltipJobs: "Jobs",
    staffingCandidatesTooltipWishes: "Wünsche",
    staffingCandidatesTooltipLastAssignment: "Zuletzt eingesetzt",
    staffingCandidatesTooltipLastAssignmentToday: "heute",
    staffingCandidatesTooltipLastAssignmentDaysAgoOne: "vor 1 Tag",
    staffingCandidatesTooltipLastAssignmentDaysAgo: "vor {days} Tagen",
    staffingCandidatesTooltipNextAssignment: "Nächster Einsatz",
    ...
    staffingCandidatesTooltipWishArea: "Wunschbereich",
    staffingCandidatesTooltipNoAbsence: "Keine",
    staffingCandidatesTooltipLoading: "Informationen werden geladen…",
    staffingCandidatesTooltipError: "Informationen konnten nicht geladen werden.",
  },
  shiftAssign: {
  ...
  shiftConfirmation: {
    ...
    communication: {
      ...
      confirmCancellationConfirmOne:
        "Soll die Mitarbeiter-Absage für diese Schicht bestätigt werden?",
      confirmCancellationConfirmMany:
        "Sollen {count} Mitarbeiter-Absagen bestätigt werden?",
      confirmCancellationSuccess: "{count} Absagen bestätigt.",
      partialConfirmCancellation:
        "{done} Absagen bestätigt, {failed} fehlgeschlagen.",
  ...
  organization: {
    ...
    compensationPlanningDisclaimer:
      "Angezeigte Kosten im Einsatzbereich-Kalender sind Planungswerte und ersetzen keine Lohnabrechnung oder revisionssichere Belege.",
    ...
    errors: {
      ...
      saveFailed: "Speichern fehlgeschlagen",
      invalidName: "Bitte einen Organisationsnamen mit 1 bis 30 Zeichen eingeben.",
      invalidShiftConfirmationPendingAfter:
        "Bitte eine gültige Frist in 30-Minuten-Schritten wählen.",
      migrationShowCompensationInPlanningUi:
        "Diese Einstellung ist in der Datenbank noch nicht verfügbar. Bitte die Migration 20260703_organization_show_compensation_in_planning_ui.sql im Supabase SQL Editor ausführen.",
    },
  },
};
