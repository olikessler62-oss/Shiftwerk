export const de = {
  ...
  locations: {
    ...
    staffingEnterCount: "Bitte für jede Funktion eine Anzahl eingeben.",
    ...
    staffingQualificationsSection: "Funktionen",
    ...
    staffingDuplicateQualification:
      "Jede Funktion darf pro Servicezeit nur einmal vorkommen.",
