export const de = {
  ...
  nav: {
    dashboard: "Dashboard",
    calendar: "Kalender",
    areaCalendar: "Einsatzort-Kalender",
    employeeCalendar: "Mitarbeiter-Kalender",
    planning: "Einsatzort-Kalender",
    ...
    superadminTestScenarioBiergartenHadrianDescription:
      "Zwei Standorte mit je Restaurant, Küche und Bar; Schichtvorlagen Früh/Mittel/Spät; Servicezeiten Mo–Mi, Fr–So (Do geschlossen); zufällige Schichten aus dem Mitarbeiter-Pool mit offenen und gedeckten Fenstern.",
    superadminTestScenarioBiergartenHadrianSuccess:
      "Szenario angelegt (KW ab {weekStart}): {locationCount} Standorte, {areaCount} Bereiche, {shiftCount} Schichten — {coveredSlots} gedeckte und {openSlots} offene Bedarfsslots.",
    superadminTestScenarioBiergartenHadrianCurrentWeekTitle:
      "Biergarten & Hadrian-Eck · aktuelle KW voll besetzt",
    superadminTestScenarioBiergartenHadrianCurrentWeekDescription:
      "Wie Biergarten & Hadrian-Eck, löscht aber zuerst alle Schichten beider Standorte und legt nur für die aktuelle Kalenderwoche Schichten an — vollständig besetzt, Status bestätigt.",
    superadminTestScenarioBiergartenHadrianCurrentWeekSuccess:
      "Szenario angelegt (KW ab {weekStart}): {locationCount} Standorte, {areaCount} Bereiche, {shiftCount} bestätigte Schichten — {coveredSlots} besetzte Bedarfsslots, {openSlots} offen.",
    superadminTestScenarioFriseurSalonZentraleTitle: "Zentrale · Friseur-Salon",
    superadminTestScenarioFriseurSalonZentraleSuccess:
      "Szenario „Lucy's Hairstylings“ angelegt (KW ab {weekStart}): {locationCount} Standort, {areaCount} Einsatzort, {shiftCount} bestätigte Schichten — {coveredSlots} besetzte Bedarfsslots, {openSlots} offen.",
    superadminTestScenarioPflegedienstZentraleTitle: "Zentrale · Pflegedienst",
    superadminTestScenarioPflegedienstZentraleSuccess:
      "Szenario „OKE Medicare“ angelegt (KW ab {weekStart}): {locationCount} Standort, {areaCount} Einsatzorte, {shiftCount} bestätigte Schichten — {coveredSlots} besetzte Bedarfsslots, {openSlots} offen.",
  ...
  areaCalendar: {
    ...
    noShiftTemplatesForArea:
      "Für diesen Einsatzort sind noch keine Schichtvorlagen hinterlegt. Legen Sie welche unter Standorte → Einsatzort → Schichtvorlagen an.",
  },
  shiftTypes: {
    title: "Schichtarten",
  ...
  locations: {
    ...
    yes: "Ja",
    no: "Nein",
    areasTitle: "Einsatzorte",
    areasEmpty: "Noch keine Einsatzorte für diesen Standort.",
    ...
    areaEdit: "Ändern",
    areaDelete: "Löschen",
    areaCreateTitle: "Einsatzort anlegen",
    areaEditTitle: "Einsatzort bearbeiten",
    ...
    archiveHint:
      "Entfernte Standorte und Einsatzorte werden archiviert — bestehende Schichten und spätere Kosten bleiben korrekt zuordenbar.",
    weekdays: {
      monday: "Montag",
    ...
    panelAreas: "Einsatzorte",
    panelAreasOf: "Einsatzorte von {location}",
    panelDetails: "Details",
    panelSelected: "Einsatzort",
    ...
    selectAreaHint: "Bitte zuerst einen Einsatzort auswählen.",
    ...
    actionQualificationTemplatesHint: "Tätigkeiten für diesen Einsatzort festlegen",
    actionQualificationTemplatesConfigured: "Tätigkeitsvorlagen hinterlegt",
    areaQualificationTemplatesHint:
      "Welche Tätigkeiten an diesem Einsatzort für Personalbedarf relevant sind.",
    areaQualificationTemplatesEmpty:
      "Noch keine Tätigkeitsvorlagen für diesen Einsatzort.",
    ...
    areaShiftTemplatesHint:
      "Optional: Vorlagen zum schnellen Ausfüllen von Zeiten beim Zuweisen im Einsatzort-Kalender.",
    areaShiftTemplatesEmpty: "Noch keine Schichtvorlagen für diesen Einsatzort.",
    ...
    areaShiftTemplatesMax: "Maximal {max} Schichtvorlagen pro Einsatzort.",
    areaShiftTemplatesCopyApply: "Schichtvorlagen übernehmen von",
    areaShiftTemplatesCopySelectArea: "Einsatzort mit Schichtvorlagen",
    ...
    serviceHoursCopySelectArea: "Einsatzort mit Servicezeiten",
    ...
    staffingNoServiceHours:
      "Legen Sie zuerst Servicezeiten für diesen Einsatzort an.",
    staffingNoQualifications:
      "Legen Sie zuerst Tätigkeiten unter Einstellungen an.",
    staffingNoAreaQualificationTemplates:
      "Für diesen Einsatzort sind noch keine Tätigkeitsvorlagen hinterlegt. Bitte unter Standorte → Tätigkeitsvorlagen mindestens eine Tätigkeit zuweisen.",
    staffingAllQualificationsAssigned:
      "Alle Tätigkeiten dieses Einsatzorts sind bereits eingetragen.",
    ...
    staffingCopySelectArea: "Einsatzort mit Personalbedarf",
    staffingListHint:
  ...
  settings: {
    ...
    showCompensationInPlanningHint:
      "In Mitarbeiter-Kalender, Einsatzort-Kalender und Dashboard (Statuszeilen und Tooltips).",
    absences: {
      title: "Abwesenheiten",
  ...
  dashboardExt: {
    ...
    openDayInCalendar: "Tag im Einsatzort-Kalender öffnen",
    ...
    openAreaCalendar: "Einsatzort-Kalender öffnen",
  ...
  dashboard: {
    ...
    calendarNavArea: "Einsatzort-Kal.",
    ...
    dayDrilldownAreaComboboxAriaLabel: "Einsatzort in der Tagesansicht auswählen",
    ...
    staffingCandidatesOpenCalendar: "Einsatzort-Kalender öffnen",
  ...
  organization: {
    ...
    compensationPlanningDisclaimer:
      "Angezeigte Kosten im Einsatzort-Kalender sind Planungswerte und ersetzen keine Lohnabrechnung oder revisionssichere Belege.",
