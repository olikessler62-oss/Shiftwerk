...
export const en = {
  ...
  nav: {
    ...
    superadminTestScenarioBiergartenHadrianDescription:
      "Sets the organization name to “Giovanni's Gastro”, removes all existing work sites and shifts, resets qualifications (waiter, barista, cook, dishwasher), and recreates only Biergarten and Hadrian-Eck. Shifts for the current and next calendar week are created or left open depending on the selection.",
    superadminTestScenarioBiergartenHadrianShiftModeLabel: "Shifts (current + next week)",
    superadminTestScenarioBiergartenHadrianShiftModeOpen: "Open only",
    superadminTestScenarioBiergartenHadrianShiftModeCovered: "Fully staffed",
    superadminTestScenarioBiergartenHadrianShiftModeMixed: "Open/staffed mixed",
