...
export const en = {
  ...
  nav: {
    ...
    superadminTestScenarioBiergartenHadrianDescription:
      "Sets the organization name to “Giovanni's Gastro”, removes all existing work sites and shifts, resets qualifications (waiter, barista, cook, dishwasher), and recreates only L'Orangerie and Biergarten as two separate locations. Shifts for the current and next calendar week are created or left open depending on the selection.",
    superadminTestScenarioShiftsPerDayLabel: "Shifts per day",
    superadminTestScenarioShiftsPerDayOne: "One shift per day",
    superadminTestScenarioShiftsPerDayTwo: "Two shifts per day",
    superadminTestScenarioShiftsPerDayThree: "Three shifts per day",
    superadminTestScenarioShiftLabel: "Shift {index}",
    superadminTestScenarioTabBiergarten: "Beer garden",
    superadminTestScenarioTabFriseur: "Hair salon",
    superadminTestScenarioTabPflege: "Care service",
    superadminTestScenarioShiftModeLabel: "Staffing",
    superadminTestScenarioShiftModeOpen: "Open only",
    superadminTestScenarioShiftModeCovered: "Fully staffed",
    superadminTestScenarioShiftModeMixed: "Open/staffed mixed",
    superadminTestScenarioBiergartenHadrianSuccess:
      "Scenario “Giovanni's Gastro” created (week from {weekStart}, 2 weeks): {locationCount} locations, {areaCount} areas, {shiftCount} shifts — {coveredSlots} covered and {openSlots} open demand slots.",
    ...
    superadminTestScenarioPflegedienstZentraleSuccess:
      "Scenario “Giovanni's Gastro” created (week from {weekStart}): location “Medicare Pflegedienst” with {areaCount} work sites (Tour 1–5), {shiftCount} confirmed shifts — {coveredSlots} filled demand slots, {openSlots} open.",
  ...
  settings: {
    ...
    organizationNameHint: "Displayed across the app as your business name. Maximum 30 characters.",
    shiftConfirmationPendingAfterLabel: "Deadline until status “Pending”",
    shiftConfirmationPendingAfterHint:
      "Time after a confirmation request when the status changes from “Requested” to “Pending”.",
  ...
  dashboard: {
    ...
    opsHealthLabel: "Week score",
    opsHealthGood: "Stable",
    opsHealthWatch: "Watch",
    opsHealthCritical: "Critical",
    opsWeekCoverage: "Week coverage",
    opsOpenSlotsWeek: "Open (week)",
    opsCriticalAreas: "Critical areas",
    opsTodayOk: "Fully staffed today",
    opsTodayOpen: "{count} open slots today",
    opsShiftsToday: "{count} shifts today",
    ...
    backToWeekView: "back to week view",
    ...
    dayCardFooterLine: {
      ...
      rejected: "rejected",
      canceled: "canceled",
      swap_requested: "emp. requests swap",
      unresolved: "unclear",
    },
    ...
    staffingViewCompact: "Details per status",
    staffingViewIncludePastDays: "incl. past days",
    ...
    staffingCandidatesTooltipAssignmentWeeklyHoursInclusive:
      "Weekly hrs: (incl.) {projected}/{target}",
  ...
  shiftConfirmation: {
    ...
    communication: {
      ...
      confirmCancellationConfirmOne:
        "Confirm the employee cancellation for this shift?",
      confirmCancellationConfirmMany:
        "Confirm {count} employee cancellations?",
      confirmCancellationSuccess: "{count} cancellations confirmed.",
      partialConfirmCancellation:
        "{done} cancellations confirmed, {failed} failed.",
  ...
  organization: {
    ...
    errors: {
      ...
      saveFailed: "Save failed",
      invalidName: "Please enter an organization name between 1 and 30 characters.",
      invalidShiftConfirmationPendingAfter:
        "Please choose a valid deadline in 30-minute steps.",
