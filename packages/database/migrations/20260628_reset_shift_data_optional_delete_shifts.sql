-- Daten-Reset: optional Schichten und zugehörige Workflow-Daten erhalten.

drop function if exists public.reset_organization_shift_data(uuid);

create or replace function public.reset_organization_shift_data(
  p_organization_id uuid,
  p_delete_shifts boolean default true
)
returns void
language plpgsql
security definer
...
grant execute on function public.reset_organization_shift_data(uuid, boolean) to service_role;
