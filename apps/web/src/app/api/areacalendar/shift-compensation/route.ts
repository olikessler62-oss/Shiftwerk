...
import { loadAreaCalendarShiftCompensation } from "@/lib/load-areacalendar-shift-compensation";
...
export async function POST(request: Request) {
  ...
  const result = await loadAreaCalendarShiftCompensation(db, orgId, shifts);
