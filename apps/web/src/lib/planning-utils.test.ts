...
import { getDashboardWeekHeaderParts } from "./planning-utils";

describe("getDashboardWeekHeaderParts", () => {
  it("shows a single month and year within one calendar year", () => {
    const parts = getDashboardWeekHeaderParts("2026-06-08", "de-DE");
  ...
  it("shows both month/year labels when the week spans two years", () => {
    const parts = getDashboardWeekHeaderParts("2026-12-28", "de-DE");
  ...
  it("shows both months with a shared year when the week spans two months", () => {
    const parts = getDashboardWeekHeaderParts("2026-11-30", "de-DE");
