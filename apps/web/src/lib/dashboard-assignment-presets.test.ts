...
} from "./dashboard-assignment-presets";

function preset(
  overrides: Partial<DashboardAssignmentPreset> &
    Pick<DashboardAssignmentPreset, "id" | "start_time" | "end_time">
...
describe("dashboard-assignment-presets", () => {
