...
import { resolveDashboardAssignPrefillFromOpenDemand } from "./dashboard-assign-prefill";
...
describe("resolveDashboardAssignPrefillFromOpenDemand", () => {
  it("prefills earliest open demand that fits the employee", () => {
    const result = resolveDashboardAssignPrefillFromOpenDemand({
      employeeId,
      dateISO,
      areaId,
      staffingEntries: [
