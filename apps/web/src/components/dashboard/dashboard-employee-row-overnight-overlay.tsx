...
import { DashboardOvernightSpanCard } from "@/components/dashboard/dashboard-overnight-span-card";
...
export function DashboardEmployeeRowOvernightOverlay({
  employeeId,
  employeeName,
  spans,
  dayColumnCount,
  ...
  useLayoutEffect(() => {
    ...
    const calendarGrid = overlay.closest("[data-dashboard-calendar-grid]");
