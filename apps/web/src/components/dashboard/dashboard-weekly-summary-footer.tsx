...
export function DashboardWeeklySummaryFooter({
  summary,
  locale,
  gridRow,
  t,
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col leading-[1.1]">
          <span className="text-[10px] font-semibold text-foreground">
            {t("dashboard.weeklySummaryTitleLine1")}
          </span>
          <span className="text-[10px] font-semibold text-foreground">
            {t("dashboard.weeklySummaryTitleLine2")}
          </span>
        </div>
      </div>
      ...
      >
        <WeeklySummaryStat
          label={t("dashboard.weeklySummaryPlannedHours")}
          value={`${summary.plannedHours} ${hoursUnit}`}
        />
        <WeeklySummaryStat
          label={t("dashboard.weeklySummaryTargetHours")}
